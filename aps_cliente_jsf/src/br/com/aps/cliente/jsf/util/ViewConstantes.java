...
public final class ViewConstantes {
	...
	public static final String DATA_TABLE_REGISTROS_POR_PAGINA = "20";
	public static final String DATA_TABLE_PAGE_LINKS = "5";
	...
	public static final String NOME_PARAMETRO_OUTCOME = "outcome";
	
	public static final String NOME_PARAMETRO_TIPO_FLUXO_CRUD = "tipoFluxoCRUD";

	
	

	private ViewConstantes() {
	}
